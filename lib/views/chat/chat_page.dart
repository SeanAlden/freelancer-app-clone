      ...
      body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasError) {
              ...
              return Center(
                child: Text('no_chat_available'
                    .tr), // Jika tidak ada data, tampilkan pesan kosong
              );
            } else {
              final chatRoom =
              ...
              return Container(
                ...
                child: ListView.separated(
                  shrinkWrap: false,
                  itemCount:
                      chatRoom.length, // Jumlah item sesuai banyaknya chat
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Expanded(
                      ...
                      child: ConversationList(
                        ...
                        //       messageText:
                        //           item['message'] ?? '', // Pesan terakhir
                        //       url: otherUser
                        //           .piclink, // URL gambar profil lawan bicara
                        //       time: formattedDate, // Waktu pesan terakhir
                        //       chatId: chatRoom[index]
                        //           ['chatRoom_id'], // ID chat room
                        //       userList: [
                        //         user!,
                        //         otherUser
