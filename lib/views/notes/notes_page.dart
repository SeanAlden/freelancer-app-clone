...
import 'package:clone_freelancer_mobile/controllers/note_controller.dart';
import 'package:clone_freelancer_mobile/models/notes.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
          ...
          child: ListView(
            children: [
              TextFormField(
                ...
                onChanged: (v) => title = v,
                validator: (v) =>
                    v == null || v.isEmpty ? 'please_enter_a_title'.tr : null,
              ),
              SizedBox(height: 10),
              TextFormField(
                initialValue: content,
                ...
                maxLines: null,
                validator: (v) =>
                    v == null || v.isEmpty ? 'please_enter_content'.tr : null,
              ),
              SizedBox(height: 20),
              ElevatedButton(
                onPressed: () async {
